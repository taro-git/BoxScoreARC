...
from rest_api.serializers.season_summary import RegularSeasonTeamStatsCreate, SeasonSummaryCreate, SeasonSummarySerializer
...
def fetch_regular_season_team_stats(season: str, team_id: int) -> RegularSeasonTeamStatsCreate:
    ...
    if season == team_info_common["SEASON_YEAR"].iloc[0]:
        ...
        raise ValueError(f'not match season, request value is {season}, responce value is {team_info_common["SEASON_YEAR"].iloc[0]}')
...
def update_regular_season_team_stats(season_summary: SeasonSummary, regular_season_team_stats_create: RegularSeasonTeamStatsCreate):
    ...
    team_stats_exists = regular_season_team_stats_create['team_id'] in [team_stats.team_id for team_stats in regular_season_teams_stats]
