<template>
  <v-container>
    <v-row>
      <v-col class="d-flex align-center"> Theme Color </v-col>
      <v-col class="d-flex align-center">
        <v-btn @click="colorPicker = true">Open Color Palette</v-btn>
      </v-col>
    </v-row>
    <v-row>
      <v-col class="d-flex align-center"> Display Score </v-col>
      <v-col class="d-flex align-center">
        <v-switch
          v-model="settings.scoreDisplay"
          color="primary"
          hide-details
          inset
        />
    ...
    <v-row>
      <v-col class="d-flex align-center"> Default Range of Quarter </v-col>
      <v-col class="d-flex align-center">
        <v-select
          v-model="settings.defaultQuarterRangeType"
...
const themeColorModel = computed({
  ...
  set: (val: string) => {
    settings.themeColor = isValidRgbaColor(val)
      ? val
      : DEFAULT_THEME_COLOR_BASE;
  },
});
</script>
